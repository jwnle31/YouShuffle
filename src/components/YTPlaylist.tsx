      ...
      <div className="p-4 sm:p-10">
        <div className="flex justify-end">
          <a
            ...
            className="flex items-center px-3 py-1 font-semibold text-gray-800 transition-transform transform bg-yellow-400 rounded-full shadow-md whitespace-nowrap shine-effect sm:px-4 sm:py-2 w-min hover:bg-yellow-300 hover:scale-105">
